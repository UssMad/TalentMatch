...
Defines the behavior for automatically dispatching AI analysis when a candidate CV is submitted or updated, eliminating the need for manual analysis triggers.
