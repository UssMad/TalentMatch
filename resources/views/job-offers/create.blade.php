<x-app-layout>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('job-offers.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div id="skills-container" class="mt-1 space-y-2">
                                <div class="flex gap-2">
                                    <x-text-input type="text" name="required_skills[]" placeholder="e.g. PHP" class="flex-1" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="min_experience" name="min_experience" type="number" class="mt-1 block w-full" :value="old('min_experience', 0)" min="0" required />
    ...
    <script>
        function addSkill() {
            ...
            div.innerHTML = `
                <input type="text" name="required_skills[]" placeholder="e.g. PHP" class="flex-1 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required />
